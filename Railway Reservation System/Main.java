...
//                     System.out.print("Enter the destination code: ");
//                     destinationCode = sc.nextLine();
            
//                     List<Train> availableTrains1 = reservationSystem.findAvailableTrains(currentCode, destinationCode);
            
//                     if (availableTrains1.isEmpty()) {
//                         System.out.println("No trains available for this route.");
//                     } else {
//                         System.out.println("Available Trains:");
//                         for (Train train : availableTrains1) {
//                             System.out.println("Train Number: " + train.getTrainNumber());
//                             System.out.println("Train Name: " + train.getTrainName());
//                             System.out.println("Total Seats: " + train.getTotalSeats());
//                             System.out.println("Available Seats: " );
...
//                             System.out.println();
//                         }
//                         System.out.print("Enter the train number to see available seats: ");
//                         String selectedTrainNumber = sc.nextLine();
//                         Train train = null;
//                         for (Train trains : availableTrains1) {
//                             if (trains.getTrainNumber().equalsIgnoreCase(selectedTrainNumber)) {
//                                 train = trains;
//                                 break;
//                             }
